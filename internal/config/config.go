...
// SetAutoModeForCabinet - устанавливает режим авто для кабинета
...
// IsAutoModeEnabledForCabinet - проверяет включен ли авто-режим
...
// GetAutoModeStatusForAllCabinets - возвращает статус авто-режима для всех кабинетов
